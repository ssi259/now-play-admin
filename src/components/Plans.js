...
=======
import 'bootstrap/dist/css/bootstrap.min.css';
>>>>>>> 0ece037 (Implemented plans Listing and Creating Components)
...
=======
    ...
    return (
        <div className="batch-list">
            <h3 className="batch-heading">Plans <button onClick={() => { setOpenModal(true) }}>{<MdAdd />}</button>{openModal && <PlansModal closeModal={setOpenModal} />}</h3>
